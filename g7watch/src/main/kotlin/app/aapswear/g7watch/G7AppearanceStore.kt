...
enum class G7AppearanceRole(
    ...
    MENU_BACKGROUND("menu_background", "App-Hintergrund", G7AppearanceSection.MENU, 0xFF181818.toInt()),
    MENU_SURFACE("menu_surface", "Tile-Hintergrund", G7AppearanceSection.MENU, 0xFF242424.toInt()),
    MENU_BORDER("menu_border", "Tile-Kontur", G7AppearanceSection.MENU, 0xFF404040.toInt()),
    MENU_TEXT_PRIMARY("menu_text_primary", "Haupttext", G7AppearanceSection.MENU, 0xFFF5F5F5.toInt()),
    MENU_TEXT_SECONDARY("menu_text_secondary", "Sekundärtext", G7AppearanceSection.MENU, 0xFFB5B5B5.toInt()),
    ...
    GRAPH_BACKGROUND("graph_background", "Graph-Hintergrund", G7AppearanceSection.GRAPH, 0xFF202020.toInt()),
    GRAPH_TARGET_AREA("graph_target_area", "Zielbereichsfläche", G7AppearanceSection.GRAPH, 0x665C5C5C),
    GRAPH_HIGH_AREA("graph_high_area", "High-Fläche", G7AppearanceSection.GRAPH, 0x45FFD040),
    GRAPH_LOW_AREA("graph_low_area", "Low-Fläche", G7AppearanceSection.GRAPH, 0x45FF5C69),
    GRAPH_HIGH_LINE("graph_high_line", "High-Grenzlinie", G7AppearanceSection.GRAPH, 0xFFFFD040.toInt()),
    GRAPH_LOW_LINE("graph_low_line", "Low-Grenzlinie", G7AppearanceSection.GRAPH, 0xFFFF5C69.toInt()),
    GRAPH_DOT_HIGH("graph_dot_high", "CGM-Dots · hoch", G7AppearanceSection.GRAPH, 0xFFFFD040.toInt()),
    GRAPH_DOT_IN_RANGE("graph_dot_in_range", "CGM-Dots · im Ziel", G7AppearanceSection.GRAPH, 0xFFFFFFFF.toInt()),
    GRAPH_DOT_LOW("graph_dot_low", "CGM-Dots · tief", G7AppearanceSection.GRAPH, 0xFFFF5C69.toInt()),
    GRAPH_DOT_OUTLINE("graph_dot_outline", "Dot-Kontur", G7AppearanceSection.GRAPH, 0xFF000000.toInt()),
