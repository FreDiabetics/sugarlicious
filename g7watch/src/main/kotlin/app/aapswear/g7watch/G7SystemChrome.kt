...
internal fun applyG7SystemChrome(window: Window, background: Int) {
    ...
    val appearance = if (lightIcons) 0 else {
...
private fun setLegacyG7SystemBarColors(window: Window, background: Int) {
