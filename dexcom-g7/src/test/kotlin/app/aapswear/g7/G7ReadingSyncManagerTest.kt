...
class G7ReadingSyncManagerTest {
    @Test
    fun `pending readings remain unsynced until mobile acknowledgement`() =
        runBlocking {
    ...
    @Test
    fun `empty queue and empty acknowledgement are no ops`() =
        runBlocking {
    ...
    private class FakeRepository(
        private val readings: List<CgmReading>,
        ...
        override suspend fun getUnsynced(limit: Int): List<CgmReading> = readings.filterNot { it.id in syncedIds }.take(limit)
